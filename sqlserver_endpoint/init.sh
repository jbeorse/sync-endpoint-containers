...
SETTINGSNAME="odk-sqlserver-settings-latest"
...
## JDBC URL
JDBCURL_PROP="s/jdbc\.url=.*/jdbc\.url=jdbc:sqlserver:\/\/$DB_URL;database=$DB_NAME;user=${DB_USERNAME:="odk_user"};password=$DB_PASSWORD;encrypt=true;trustServerCertificate=${TRUST_SERVER_CERT:="false"};hostNameInCertificate=${SERVER_HOST_IN_CERT:="*.database.windows.net"};loginTimeout=30;authentication=ActiveDirectoryPassword/g"
## Database Schema
