...
"docker run -d -p 80:8080 -e SERVER_URL="0.0.0.0" -e SERVER_PORT="80" -e SERVER_SECURE_PORT="8443" -e DB_URL="test-psql-launch.c0xiufqyar8g.us-west-2.rds.amazonaws.com" -e DB_NAME='odk_prod' -e DB_USERNAME="odk_user" -e DB_PASSWORD="PASSWORD" -e DB_SCHEMA="odk_prod" -e LDAP_DOMAIN_L1="com" -e LDAP_DOMAIN_L2="mezuricloud" -e LDAP_USERNAME="ldap_reader@mezuricloud.com" -e LDAP_PASSWORD="PASSWORD" -e REALM_STRING="opendatakit.org ODK Aggregate" -e GROUP_PREFIX="mitch_prod" -e CHANNEL_TYPE="ANY_CHANNEL" -e SECURE_CHANNEL_TYPE="ANY_CHANNEL"  jbeorse/psql_endpoint"
